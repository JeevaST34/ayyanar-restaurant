export default function SignatureDishes() {
  const dishes = [
    ...
    },
    {
      name: "Parotta Combo",
      price: "Rs. 220",
      description: "Flaky layered parotta served with rich salna, onion relish, and curry.",
    ...
    },
    {
      name: "Seafood Fry",
      price: "Rs. 350",
      description: "Fresh catch marinated with chilli, pepper, curry leaf, and crisp-fried edges.",
