    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-end gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="max-w-4xl">
          ...
          <h1 className="max-w-4xl text-5xl leading-[0.96] font-semibold tracking-normal text-[#3B2A24] sm:text-6xl lg:text-8xl">
            Ayyanar Restaurant
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-[#5B4A42]">
