      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        <div className="mb-14 grid gap-8 lg:grid-cols-2 lg:items-end">
          <div>
            ...
            <h2
              className="text-4xl leading-[1.1] font-black text-[#075985] md:text-5xl"
              style={{
            ...
            >
              A taste of our
              <br />
              <em className="font-bold text-[#0284c7] italic">
                everyday favourites.
              </em>
            </h2>
          </div>
          <p className="text-[0.9rem] leading-7 font-medium text-[#0369a1] lg:max-w-sm lg:self-end">
            Enjoy the signature South Indian dishes served at Ayyanar, then
            visit the full menu page for the complete selection.
          </p>
        </div>
        ...
        <div className="mb-8 flex flex-wrap items-center gap-3">
          ...
          <MotionLink
            href="/menu#monthly"
            className="rounded-full border-2 border-[#bae6fd] bg-white px-6 py-2.5 text-[0.8rem] font-black tracking-wide text-[#0369a1] shadow-sm transition duration-300 hover:border-[#7dd3fc] hover:bg-[#eff8ff] hover:text-[#0284c7]"
          >
            Monthly Plan
          </MotionLink>
        </div>
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at center, #7dd3fc 0%, #38bdf8 100%)",
            }}
          >
            <h3
            ...
            <p className="mt-1 text-[0.85rem] font-bold text-[#0369a1]">
              {category.note}
            </p>
          </div>
            ...
            {category.items.map((item) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-[0.85rem] font-medium text-[#0369a1]">
                    {item.description}
                  </p>
                </div>
                {/* Dotted line */}
                <div className="mx-4 flex-1 self-center border-b-2 border-dashed border-[#bae6fd]" />
                {/* Price */}
                <span className="inline-flex shrink-0 items-center justify-center rounded-full border border-[#bae6fd] bg-[#f0f9ff] px-4 py-2 text-[0.95rem] font-black whitespace-nowrap text-[#f97316] shadow-sm">
                  {item.price}
                </span>
              </div>
            ))}
